...
namespace ProjetoFinalBruno.Controllers
{
    public class TipoProcedimentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ObservacaoRealizacao")] TipoProcedimento tipoProcedimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ObservacaoRealizacao")] TipoProcedimento tipoProcedimento)
        {
