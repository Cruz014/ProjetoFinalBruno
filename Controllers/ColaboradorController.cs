...
namespace ProjetoFinalBruno.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "Id", "Id", colaborador.CidadeId);
            ViewData["TipoColaboradorId"] = new SelectList(_context.TipoColaborador, "Id", "Id", colaborador.TipoColaboradorId);
            return View(colaborador);
        }
